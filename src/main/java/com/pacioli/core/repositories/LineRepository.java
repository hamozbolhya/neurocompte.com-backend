...
public interface LineRepository extends JpaRepository<Line, Long> {
    ...
    Long countManuallyUpdatedLinesInPeriod(@Param("startDate") LocalDate startDate,
    ...
    List<Object[]> countManuallyUpdatedLinesByCabinetInPeriod(@Param("startDate") LocalDate startDate,
            @Param("endDate") LocalDate endDate);
    ...
    Long countManuallyUpdatedLinesByCabinetAndPeriod(@Param("cabinetId") Long cabinetId,
